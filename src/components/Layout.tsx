                    ...
                    <div
                        ...
                        <div className="flex items-center space-x-6 order-2 md:order-3">
                            ...
                            {isAuthenticated && user ? (
                                <Link
                                    to="/my-items"
                                    className="bg-[#5865F2] hover:bg-[#4752C4] text-white font-medium px-4 py-2 rounded-lg transition-colors duration-200 flex items-center gap-2 shadow-sm"
                                >
                                    <img
                                        src={user.avatarUrl}
                                ...
                                <>
                                    ...
                                    <button
                                        onClick={() => login()}
                                        className="bg-[#5865F2] hover:bg-[#4752C4] text-white font-medium px-4 py-2 rounded-lg transition-colors duration-200 flex items-center gap-2 shadow-sm cursor-pointer"
                                    >
